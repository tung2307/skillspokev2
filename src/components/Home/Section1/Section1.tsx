    ...
    <>
      <div className="flex h-[90vh] w-screen flex-col items-center justify-center">
        <div className="flex flex-row text-4xl font-bold">
          <div className="text-[#FF7F50]">Love it </div>
          <div className="font-normal">&nbsp;or&nbsp;</div>
          <div className="text-[#008000]">Hate it</div>
        </div>
        <div className="pl-40 text-4xl font-bold text-[#4682B4]">
          Express Your Voice!
        </div>
        <div className="flex h-96 flex-col gap-5 pt-10 text-2xl">
          <input
            className="h-10  border-b-2 pl-2 outline-none md:w-[100%] lg:w-96 "
          ...
          <div
            className="mr-2 flex w-[7rem] items-center justify-center rounded-r border-b border-l border-r border-t bg-white shadow hover:cursor-pointer hover:bg-[#4682B4] hover:text-white"
